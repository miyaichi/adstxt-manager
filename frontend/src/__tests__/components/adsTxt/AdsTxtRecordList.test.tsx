...
jest.mock('@aws-amplify/ui-react', () => {
  ...
  const createSearchFieldComponent = () => ({ label, onChange, value, ...props }: any) => (
  ...
  const createPaginationComponent = () => ({ currentPage, totalPages, onChange, onNext, onPrevious, ...props }: any) => (
